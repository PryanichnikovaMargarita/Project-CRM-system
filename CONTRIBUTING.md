...
linking exception](mylibgit/COPYING).

The `examples` code is governed by the
[CC0 Public Domain Dedication](mylibgit/examples/COPYING), so that you may copy
...
- http-parser is licensed under [MIT license](mylibgit/deps/http-parser/COPYING)
- pcre is governed by [BSD license](mylibgit/deps/pcre/LICENCE)
- winhttp is governed by [LGPL v2.1+](mylibgit/deps/winhttp/COPYING.LGPL) and [GPL v2 with linking exception](mylibgit/deps/winhttp/COPYING.GPL)
- zlib is governed by [zlib license](mylibgit/deps/zlib/COPYING)
...
* Add to the [`changelog.md`](mylibgit/docs/changelog.md) file describing any major changes
...
at the [conventions file](mylibgit/docs/conventions.md).

## Starter Projects

See our [projects list](mylibgit/docs/projects.md).
/пытаюсь изменить файл/
/bpvtyz. afqk/
/меняю файл/
/добавление новых строк, чтобы пересохранить коммит/
